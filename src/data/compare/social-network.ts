...
export const socialNetworkData: ComparisonData = {
  ...
  features: [
    { icon: Shield, feature: "Identity Verification", findoo: "SEBI/AMFI/IRDAI registry-linked verification with trust badges", competitor: "Blue tick based on popularity or payment, no professional verification", findooHas: true, competitorHas: false },
    { icon: Briefcase, feature: "Professional Profiles", findoo: "Regulatory IDs, certifications (CFP, CFA, NISM), AUM, specializations", competitor: "Generic bio, photos, and personal interests", findooHas: true, competitorHas: false },
    { icon: Target, feature: "Audience Relevance", findoo: "100% financial ecosystem — every connection is professionally relevant", competitor: "Mixed audience of friends, family, brands, and bots", findooHas: true, competitorHas: false },
    { icon: MessageCircle, feature: "Content Quality", findoo: "Market insights, regulatory updates, product analysis, client queries", competitor: "Memes, personal updates, ads, and clickbait", findooHas: true, competitorHas: false },
    { icon: TrendingUp, feature: "Business Growth Tools", findoo: "Showcase listings, lead capture, digital business cards, event management", competitor: "Paid ads and marketplace listings (not finance-specific)", findooHas: true, competitorHas: false },
    { icon: Award, feature: "Gamification & Recognition", findoo: "XP system, professional badges, weekly challenges, leaderboard", competitor: "Likes and followers count — vanity metrics", findooHas: true, competitorHas: false },
