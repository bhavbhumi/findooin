/**
 * AdminEmailDashboard — Email monitoring with stats, filters, and log table.
 * Queries email_send_log with deduplication by message_id.
 */
...
import { Mail, CheckCircle2, XCircle, Ban, Clock, RefreshCw } from "lucide-react";
...
export function AdminEmailDashboard() {
  ...
  // Fetch all logs for the time range (deduplicated client-side by message_id)
              ...
              {isLoading ? (
                ...
                <TableRow>
                  <TableCell colSpan={5} className="text-center text-sm text-muted-foreground py-8">
                    No emails found for this filter combination
                  </TableCell>
                </TableRow>
              ) : (
                paginated.map((log) => {
