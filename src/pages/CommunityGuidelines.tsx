...
const faqs = [
  ...
  { q: "How do I report a violation?", a: "Use the report button available on any post, comment, or profile. You can also email compliance@findoo.in with details. All reports are reviewed within 48 hours. Reports are confidential — we do not reveal reporter identities to the reported User." },
  ...
  { q: "How do I appeal an enforcement action?", a: "Submit your appeal to legal@findoo.in within 30 days of the action, including your account details, a description of the enforcement action, and your reasoning for the appeal. Appeals are reviewed by a different team member within 15 business days. You will receive a written response with the appeal decision." },
