...
export const professionalNetworkData: ComparisonData = {
  ...
  features: [
    ...
    { icon: FileText, feature: "Content Relevance", findoo: "Polls, surveys & posts tailored for market analysis, product comparison, client queries", competitor: "Generic articles, job-hunting tips, and 'agree?' engagement bait", findooHas: true, competitorHas: false },
    ...
    { icon: Calendar, feature: "Financial Events", findoo: "Industry meetups, webinars with QR check-in and speaker profiles", competitor: "LinkedIn Events — generic, no industry-specific features", findooHas: true, competitorHas: true },
