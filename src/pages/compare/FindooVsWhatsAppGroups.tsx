...
const comparisonData = {
  ...
  features: [
    {
      ...
      findoo: "SEBI/AMFI/IRDAI registry-linked profiles with trust badges",
      competitor: "Phone number only — anyone can claim to be an expert",
      findooHas: true,
      competitorHas: false,
    },
    {
      ...
      findoo: "Searchable posts, hashtags, trending topics — knowledge is preserved",
      competitor: "Messages scroll away forever — no search, no archive",
      findooHas: true,
      competitorHas: false,
    },
    {
      ...
      findoo: "Structured posts, polls, surveys — moderated and reportable",
      competitor: "Forwards, PDFs, voice notes — mixed with spam and good-morning images",
      findooHas: true,
      competitorHas: false,
    },
    {
      ...
      findoo: "Full professional identity — credentials, experience, endorsements",
      competitor: "Just a phone number and display name",
      findooHas: true,
      competitorHas: false,
    },
    {
      ...
      findoo: "In-platform messaging with professional context",
      competitor: "Excellent messaging — but mixed with personal chats",
      findooHas: true,
      competitorHas: true,
    },
    {
      ...
      findoo: "Showcase, events, jobs, vault, digital card — complete professional toolkit",
      competitor: "Share PDFs and links — no business infrastructure",
      findooHas: true,
      competitorHas: false,
    },
    {
      ...
      findoo: "Granular privacy controls, audit trails, content moderation",
      competitor: "Phone number exposed to all group members, no content moderation",
      findooHas: true,
      competitorHas: false,
    },
    {
      ...
      findoo: "XP, badges, leaderboard — your contributions are tracked and rewarded",
      competitor: "No recognition system — top contributors are invisible",
      findooHas: true,
      competitorHas: false,
    },
  ],
  verdict: {
    title: "WhatsApp groups are conversations. FindOO is a professional ecosystem.",
  ...
  cta: {
    title: "Your expertise deserves more than a WhatsApp forward.",
    subtitle: "Build a verified professional identity where your knowledge is preserved, discovered, and rewarded.",
  },
};

export default function FindooVsWhatsAppGroups() {
  usePageMeta({
    title: "FindOO vs WhatsApp Groups — From Unverified Tips to Verified Professionals",
    description: "Compare FindOO with financial WhatsApp & Telegram groups. See why verified networking beats informal group chats.",
  });
