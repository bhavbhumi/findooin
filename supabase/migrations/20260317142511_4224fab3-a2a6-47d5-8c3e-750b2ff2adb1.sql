...
-- Fix search_path on email queue functions (security linter warnings)
...
DROP POLICY IF EXISTS "Service can insert referral conversions" ON public.referral_conversions;
...
DROP POLICY IF EXISTS "System can insert social proof" ON public.social_proof_events;
CREATE POLICY "System can insert social proof"
